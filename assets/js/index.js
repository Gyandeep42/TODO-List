    ...
    function createTaskCard(title, description) {
        ...
        const cardContent = `
            <div class="form-group">
                ...
                <button class="btn btn-block editBtn">Edit</button>
                <button class="btn btn-block deleteBtn">Delete</button>
                <button class="btn btn-block doneBtn">Mark as Done</button>
            </div>
        `;
